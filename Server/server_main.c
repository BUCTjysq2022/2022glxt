...
typedef struct product//***创建一个结构体
{
	int id;                  //货号
	char category[10];       //类型
	char name[30];           //名称
...
void output_all(PRODUCT *list, int length)//***自定义函数输出所有条目
{
...
void sortrank(PRODUCT *list, int length, int strategy)//***指针传参
{
